package pl.tmielecki.ecommerce.playground;
...
public class SqlTest {
    ...
    var sql = """
            ...
            VALUES 
                   ('17c02e4b', 'example produvt X', 'nice one', 10.10),
                   ('18c02e4b', 'example product Y', 'nice one', 20.20);
    ...
    void itSelectWithConditions(){
        ...
        Product product = jdbcTemplate.queryForObject(
                ...
                (rs, i) -> {
                    var loaded = new Product(UUID.randomUUID(), rs.getString("NAME"), rs.getString("DESCRIPTION"));
